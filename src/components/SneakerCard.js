...
function SneakerCard({sneaker,currentUser, handleComments, handleDeleteComment, handleUpdateComment}){
  ...
  //add the commentForm
            ...
            return(
              ...
              <button type="submit">Submit your Comments</button>
               ...
               const commentList = sneaker.comments?.map(comment =>{
                return(
                  <div>
        ...
        <h1> Sku:{sneaker.sku}</h1>
          ...
          <br></br> <br></br>
              <div className="comments">
                ...
                <button className="remove" onClick={handleDeleteClick}>Delete Comment</button>
